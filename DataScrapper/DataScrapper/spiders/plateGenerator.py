...
class PlateGenerator(scrapy.Spider):
    ...
    destinationFolderPlateGenerated = 'D:\\DeeplyLearning\\Github\\LicencePlateRecognition\\data\\image\\plateGenerated\\'
    GLOBAL_DATA = None
    pbar = None
    ...
    def start(self, spider):
        self.GLOBAL_DATA = pd.read_csv('D:\\DeeplyLearning\\Github\\LicencePlateRecognition\\data\\text\\plateGenerated.csv')

    def end(self, spider):
        self.GLOBAL_DATA.to_csv('D:\\DeeplyLearning\\Github\\LicencePlateRecognition\\data\\text\\plateGenerated.csv', encoding='utf-8', index=False)
