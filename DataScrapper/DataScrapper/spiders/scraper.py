...
class ScrapperSpider(scrapy.Spider):
    ...
    DIRECTORY_IMG_PLATE = 'D:\\DeeplyLearning\\Github\\LicencePlateRecognizer\\data\\image\\plate\\'
    DIRECTORY_IMG_GLOBAL = 'D:\\DeeplyLearning\\Github\\LicencePlateRecognizer\\data\\image\\car\\'
    ...
    def parse(self, response):
        ...
        csvData = pd.read_csv('D:\\DeeplyLearning\\Github\\LicencePlateRecognizer\\data\\text\\data.csv')
        ...
        csvData.to_csv('D:\\DeeplyLearning\\Github\\LicencePlateRecognizer\\data\\text\\data.csv', encoding='utf-8', index=False)
